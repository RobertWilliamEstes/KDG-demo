...
<div class="col-md-15">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('rides.update', $ride->id ) }}" aria-label="{{ route('rides.update') }}">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="first_name" type="first_name" class="form-control{{ $errors->has('first_name') ? ' is-invalid' : '' }}" name="first_name" required autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="last_name" type="last_name" class="form-control{{ $errors->has('first_name') ? ' is-invalid' : '' }}" name="last_name" required autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="Company" type="Company" class="form-control{{ $errors->has('Company') ? ' is-invalid' : '' }}" name="Company">
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="city" type="city" class="form-control{{ $errors->has('city') ? ' is-invalid' : '' }}" name="city" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="fare" type="int" class="form-control{{ $errors->has('fare') ? ' is-invalid' : '' }}" name="fare" required autofocus>
